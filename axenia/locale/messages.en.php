...
"bot.error" => "Ops! Something went wrong.. 🤷‍♀️",
"bot.onlyPrivate" => "Sorry, but I can do this in groups only.",
"user.pickChat" => "Please <a href='t.me/:botName?startgroup=0'>pick а group</a> where I can handle the karma points and more. ✌😊",
"chat.greetings" => "Hello! My name is Axenia and I can count the karma points.\r\nUse /help to see more about it and /settings for switching language.",
"chat.help" => "<b>💬 What can I do?</b>\r\n\r\n<b>Raising/reducing karma</b>
Type 'plus' (+ or 👍) for raising or 'minus' (- or 👎) for reducing karma points to the user, to which message it will reply.
Also, I understand formatted messages like \"+ @username\" and etc.\r\n
<b>Commands</b>
/top - show top of users in current group.
/my_stats - show your global statistics.
/settings - open dialog to change the language and to toggle Silent Mode which mutes bot comments and cooldown time between user's messages about decrease/increase karma points (admin only)
/buy - Also you can purchase some content (kitty, gif etc) with your karma points.\r\n
<i>Statistics are available on</i> axeniabot.ru.",
"user.stat.inline" => "Statistics of the 👤 :user",
"user.stat.title" => " ℹ️ <b>The user statistics</b>",
"user.stat.name" => "👤 Name: ",
"user.stat.inchat" => "📍 Karma rating in current group: ",
"user.stat.sum" => "🔮 Global karma rating: ",
...
"karma.top.footer" => "<a href=':pathToSite?chat_id=:chatId'>Read more.</a> <i>(Russian only)</i>",
"karma.top.private" => "The Karma's top is available in groups only",
...
"karma.yourself" => "Please do not do it again!",
...
"store.button.buy_ideer" => "Eavesdropped :price",
...
"store.event.buy_ideer" => "<b>:user(:k)</b> has bought story from Eavesdropped. Isn't it funny? :)",
"store.callback" => "You have bought ':buy'. You have :k karma points.",
"store.event.cant_buy" => "<b>:user(:k)</b> has not enough karma points to buy <i>':buy'</i>",
"store.callback.cant_buy" => "You don't have enough karma points to buy ':buy'",
...
"settings.titlePrivate" => "<b>🛠Settings</b> \r\nAttention please! Some operations for groups are enabled to administrators only. Also, some functions are enabled for cookies🍪. \r\nYou can add cookies with /donate command.\r\n",
"settings.adminonly" => "Access to changes is only for admins.",
...
"settings.erase.title" => "Choose group where you want to erase data for all members. This operation is for group admins only.\r\n\r\n <b>❗️ Attention! This operation cannot be undone.</b>",
"settings.erase.notallow" => "You are not administrator in groups",
"settings.erase.confirm" => "‼️Are you sure you want to erase karma in <b>\":chat\"</b>(:chat_id)?",
"settings.erase.success" => "Karma of members in <b>\":chat\"</b>(:chat_id) has been erased",
"settings.erase.cancel" => "Erase in <b>\":chat\"</b>(:chat_id) has been cancelled",
"settings.groups.adminonly" => "<b>This operation is for group admins only.</b>",
...
"donate.title" => "Please donate for my development. I will give you special currency in return - a Cookie 🍪",
"donate.price" => ":k🍪 :r₽",
...
"donate.bill" => "Excellent choice! 😉 As a reward for gratitude for the help in the project, we give you :nom cookies🍪",
"donate.pay" => "Pay bill",
